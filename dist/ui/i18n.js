export const fr = {
    ...
    body: "Des outils de mesure nous aident à améliorer le site. Rien n'est activé sans " +
        "votre accord.",
    acceptAll: "Tout accepter",
    refuseAll: "Tout refuser",
    customise: "Personnaliser",
    details: "Ce que ça couvre",
    ...
    marketingBody: "Permet de mesurer l'efficacité de nos campagnes et de vous proposer des contenus " +
        "adaptés.",
};
export const en = {
    title: "Cookies and analytics",
    body: "Analytics help us improve this site. Nothing is enabled without your agreement.",
    ...
    marketingBody: "Lets us measure how our campaigns perform and show you more relevant content.",
};
export function pickLocale(explicit) {
    if (explicit)
        return explicit === "fr" ? fr : en;
